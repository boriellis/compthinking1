...
I'm having a hard time getting this to behave correctly as a webpage - I render it, move it to the docs folder, and then do the commit push situation, but once the action is done in my repository and I click the link it just looks like html and not the prettily formatted version that it looks like on my local host?
